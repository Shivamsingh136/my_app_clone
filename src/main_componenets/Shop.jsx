          ...
          <div className="mobile-menu__menu">
            <ul className="nav-menu flex-align nav-menu--mobile">
              <li className="on-hover-item nav-menu__item has-submenu">
                <Link className="nav-menu__link" href="/shop.html">
                  Home
                </Link>
              ...
              >
                <div className="search-category style-two d-flex h-48 search-form d-sm-flex d-none">
                  <select
                    ...
                    name="state"
                    data-select2-id="select2-data-407-vkoj"
                    tabindex="-1"
                    aria-hidden="true"
                  >
                    <option
                      value="1"
                      selected=""
                      data-select2-id="select2-data-409-urmb"
                    >
                      All Categories
                    </option>
                  ...
                  <span
                    ...
                    dir="ltr"
                    data-select2-id="select2-data-408-ulfw"
                    style={{width: '151px'}}
                  >
                    <span className="selection">
                      <span
                        ...
                        tabindex="0"
                        aria-disabled="false"
                        aria-labelledby="select2-state-u1-container"
                        aria-controls="select2-state-u1-container"
                      >
                        <span
                          className="select2-selection__rendered"
                          id="select2-state-u1-container"
                          role="textbox"
                          aria-readonly="true"
        ...
        <div className="container container-lg">
          <div className="breadcrumb-wrapper flex-between flex-wrap gap-16">
            ...
            <ul className="flex-align gap-8 flex-wrap">
              ...
              <li className="text-sm text-main-600">Shop</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="container container-lg">
          <div className="row">
                  ...
                  <div className="custom--range">
                    <div className="horizontal-slider" style={{position: 'relative'}}>
                      <div
                        ...
                        style={{position: 'absolute', left: '0px', right: '151px'}}
                      ></div>
                      <div
                      ...
                      <div
                        ...
                        style={{position: 'absolute', left: '151px', right: '0px'}}
                      ></div>
                      <div
                      ...
                      <div
                        ...
                        aria-disabled="false"
                        aria-valuetext="Thumb value 100"
                        style={{
                          position: 'absolute',
                          touchAction: 'none',
                          zIndex: '2',
                    ...
                    <li className="mb-24">
                      <div className="form-check common-check common-radio checked-success">
                        <input
                          ...
                          id="color4"
                        />
                        <label className="form-check-label" for="color4">
                          Green (12)
                        </label>
                      </div>
                    </li>
                    <li className="mb-24">
                      <div className="form-check common-check common-radio checked-danger">
                        <input
                          ...
                          id="color5"
                        />
                        <label className="form-check-label" for="color5">
                          Red (12)
                        </label>
                      </div>
                    </li>
                    <li className="mb-24">
                      <div className="form-check common-check common-radio checked-white">
                        <input
                          ...
                          id="color6"
                        />
                        <label className="form-check-label" for="color6">
                          White (12)
                        </label>
                      </div>
                    </li>
                    <li className="mb-0">
                      <div className="form-check common-check common-radio checked-purple">
                        <input
                          ...
                          id="color7"
                        />
                        <label className="form-check-label" for="color7">
                          Purple (12)
                        </label>
                      </div>
                    </li>
                    ...
                    <li className="mb-24">
                      <div className="form-check common-check common-radio">
                        <input
                          ...
                          id="DELL"
                        />
                        <label className="form-check-label" for="DELL">
                          DELL
                        </label>
                      </div>
                    </li>
                    <li className="mb-0">
                      <div className="form-check common-check common-radio">
                        <input
                          ...
                          id="Redmi"
                        />
                        <label className="form-check-label" for="Redmi">
                          Redmi
                        </label>
                      </div>
                    </li>
            ...
            <div className="col-lg-9">
                ...
                <div className="position-relative flex-align gap-16 flex-wrap">
                  <div className="list-grid-btns flex-align gap-16">
                    ...
                    <button
                      ...
                      fdprocessedid="0tfld7"
                    >
                      <i className="ph ph-squares-four"></i>
                    </button>
                  </div>
                  <div className="position-relative text-gray-500 flex-align gap-4 text-14">
                    <label for="sorting" className="text-inherit flex-shrink-0">
                      Sort by:{" "}
                    </label>
                    <select
              ...
              <div className="list-grid-wrapper false">
                ...
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    <img
                      src="/images/thumbs/product-two-img7.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
                ...
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    <img
                      src="/images/thumbs/product-two-img8.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
                ...
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    <img
                      src="/images/thumbs/product-two-img10.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
                ...
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    <img
                      src="/images/thumbs/product-two-img11.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
                ...
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/images/thumbs/product-two-img12.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
                ...
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    <img
                      src="/images/thumbs/product-two-img13.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
                ...
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/images/thumbs/product-two-img15.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
