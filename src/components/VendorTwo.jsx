            ...
            >
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img1.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
                  <div className='position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <span className='w-80 h-80 flex-center bg-white rounded-circle flex-shrink-0'>
                        <img
                          src='/images/thumbs/vendors-two-icon1.png'
                          alt=''
                        />
                      </span>
                      <button
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img2.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
                  <div className='position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <span className='w-80 h-80 flex-center bg-white rounded-circle flex-shrink-0'>
                        <img
                          src='/images/thumbs/vendors-two-icon2.png'
                          alt=''
                        />
                      </span>
                      <button
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img3.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
                  <div className='position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <span className='w-80 h-80 flex-center bg-white rounded-circle flex-shrink-0'>
                        <img
                          src='/images/thumbs/vendors-two-icon3.png'
                          alt=''
                        />
                      </span>
                      <button
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img4.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img5.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
                  <div className='position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <span className='w-80 h-80 flex-center bg-white rounded-circle flex-shrink-0'>
                        <img
                          src='/images/thumbs/vendors-two-icon5.png'
                          alt=''
                        />
                      </span>
                      <button
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img6.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
                  <div className='position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <span className='w-80 h-80 flex-center bg-white rounded-circle flex-shrink-0'>
                        <img
                          src='/images/thumbs/vendors-two-icon6.png'
                          alt=''
                        />
                      </span>
                      <button
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img7.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
                  <div className='position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <span className='w-80 h-80 flex-center bg-white rounded-circle flex-shrink-0'>
                        <img
                          src='/images/thumbs/vendors-two-icon7.png'
                          alt=''
                        />
                      </span>
                      <button
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img8.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
                  <div className='position-absolute top-0 inset-inline-start-0 w-100 h-100 p-24 z-1 d-flex flex-column justify-content-between'>
                    <div className='d-flex align-items-center justify-content-between'>
                      <span className='w-80 h-80 flex-center bg-white rounded-circle flex-shrink-0'>
                        <img
                          src='/images/thumbs/vendors-two-icon8.png'
                          alt=''
                        />
                      </span>
                      <button
              ...
              <div className='vendors-two-item rounded-12 overflow-hidden bg-color-three border border-neutral-50 hover-border-main-two-600 transition-2'>
                <div className='vendors-two-item__top bg-overlay style-two position-relative'>
                  <div className='vendors-two-item__thumbs h-210'>
                    <img
                      src='/images/thumbs/vendors-two-img9.png'
                      alt=''
                      className='cover-img'
                    />
                  </div>
